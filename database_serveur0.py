...
class RequestHandler(http.server.SimpleHTTPRequestHandler):
    ...
    static_dir = 'C:\\Users\\pauln\\Documents\\Python_Scripts\\info\\appln web\\projet\\INF-tc-3-pluviometrie\\client'# on surcharge la méthode qui traite les requêtes GET  
